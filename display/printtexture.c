...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/15 21:47:31 by aparedes          #+#    #+#             */
/*   Updated: 2022/06/19 12:50:09 by aparedes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	loadtexture(t_long *sl)
{
	...
	sl->text[1] = mlx_xpm_file_to_image(sl->mlx_ptr, "./textures/wall-64.xpm",
	...
	sl->text[2] = mlx_xpm_file_to_image(sl->mlx_ptr, "./textures/enemy.xpm",
			&sl->widthtext[2], &sl->heighttext[2]);
	sl->ptr_text[2] = mlx_get_data_addr(sl->text[2],
			&(sl->bpp_text[2]), &(sl->sline_text[2]), &(sl->ed_text[2]));
	sl->text[4] = mlx_xpm_file_to_image(sl->mlx_ptr, "./textures/door.xpm",
